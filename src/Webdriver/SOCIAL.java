...
//		System.out.println("Assertion");
//		AssertTrue(driver.findElement(By.cssSelector(Webdriver.mappings.social.SIGN_UP_PB_HOW_OLD_ARE_YOU_TEXTFIELD)).isDisplayed());
		System.out.println("Assertion");		
		AssertTrue(driver.findElement(By.cssSelector(Webdriver.mappings.social.SIGN_UP_PB_DOB_DAY)).isDisplayed());
		System.out.println("Assertion");		
		AssertTrue(driver.findElement(By.cssSelector(Webdriver.mappings.social.SIGN_UP_PB_DOB_MONTH)).isDisplayed());
		System.out.println("Assertion");		
...
//		AssertTrue(driver.findElement(By.cssSelector(Webdriver.mappings.social.SIGN_UP_PB_HOW_OLD_ARE_YOU_TEXTFIELD)).isDisplayed());
	...
	public void Social07(String xUrl) throws InterruptedException {
		...
		driver.switchTo().defaultContent();
		System.out.println("Assertion");
		assertEquals("miroslaw.palysiewicz.1234567@dev.spilgames.eu", driver.findElement(By.cssSelector(Webdriver.mappings.social.SIGN_UP_PB_EMAIL_TEXTFIELD)).getAttribute("value"));
		System.out.println("Assertion");
		AssertTrue(driver.findElement(By.cssSelector(Webdriver.mappings.social.SIGN_UP_BOX)).isDisplayed());
		System.out.println("Assertion");
		AssertTrue(driver.findElement(By.cssSelector(Webdriver.mappings.social.SIGN_UP_PB_EMAIL_ERROR_ICON)).isDisplayed());
...
//		AssertTrue(driver.findElement(By.cssSelector(Webdriver.mappings.social.SIGN_UP_PB_HOW_OLD_ARE_YOU_TEXTFIELD)).isDisplayed());
//		System.out.println("Assertion");
//		AssertTrue(driver.findElement(By.cssSelector(Webdriver.mappings.social.SIGN_UP_PB_HOW_OLD_ARE_YOU_ERROR_ICON)).isDisplayed());
//		System.out.println("Assertion");
//		AssertTrue(driver.findElement(By.cssSelector(Webdriver.mappings.social.SIGN_UP_PB_HOW_OLD_ARE_YOU_ERROR_NOT_NUMBER_TEXT)).isDisplayed());		
		System.out.println("Assertion");		
		AssertTrue(driver.findElement(By.cssSelector(Webdriver.mappings.social.SIGN_UP_PB_DOB_DAY)).isDisplayed());
		System.out.println("Assertion");		
		AssertTrue(driver.findElement(By.cssSelector(Webdriver.mappings.social.SIGN_UP_PB_DOB_MONTH)).isDisplayed());
...
//		AssertTrue(driver.findElement(By.cssSelector(Webdriver.mappings.social.SIGN_UP_PB_HOW_OLD_ARE_YOU_TEXTFIELD)).isDisplayed());
//		System.out.println("Assertion");
//		AssertTrue(driver.findElement(By.cssSelector(Webdriver.mappings.social.SIGN_UP_PB_HOW_OLD_ARE_YOU_CORRECT_ICON)).isDisplayed());
		System.out.println("Assertion");		
		AssertTrue(driver.findElement(By.cssSelector(Webdriver.mappings.social.SIGN_UP_PB_DOB_DAY)).isDisplayed());
		System.out.println("Assertion");		
		AssertTrue(driver.findElement(By.cssSelector(Webdriver.mappings.social.SIGN_UP_PB_DOB_MONTH)).isDisplayed());
